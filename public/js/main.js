...
var _LinkPreview = require('./LinkPreview.html');
...
exports.default = {
  ...
  template: _LinkPreview2.default,
  ...
  methods: {
    upload: function upload() {
      var that = this;
      fetch('/previews?link=' + encodeURIComponent(this.newLink)).then(function (response) {
...
},{"./LinkPreview.html":27}],29:[function(require,module,exports){
"use strict";
...
var _LinkPreview = require("./components/LinkPreview/LinkPreview");
...
},{"./components/LinkPreview/LinkPreview":28,"vue":26,"vue-resource":15}]},{},[29]);
